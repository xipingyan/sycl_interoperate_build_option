...
//====================================================
// Kernel template: rms_gpu_bfyx_opt 
// Kernel name: rms_gpu_bfyx_opt_16553883649600634465_0_0__sa
#define KERNEL(name) __kernel void rms_gpu_bfyx_opt_16553883649600634465_0_0__sa
#define KERNEL_ID rms_gpu_bfyx_opt_16553883649600634465_0_0__sa
#define FUNC(name)  _##name##_rms_gpu_bfyx_opt_16553883649600634465_0_0__sa
#define FUNC_CALL(name)  _##name##_rms_gpu_bfyx_opt_16553883649600634465_0_0__sa
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_rms_gpu_bfyx_opt_16553883649600634465_0_0__sa []
#define CONST_ARRAY_REF(name)  _##name##_rms_gpu_bfyx_opt_16553883649600634465_0_0__sa
...
#define INPUT0_Z_PITCH (1*896)
#define INPUT0_W_PITCH (1*896*1)
#define INPUT0_U_PITCH (1*896*1*1)
#define INPUT0_V_PITCH (1*896*1*1*1)
#define INPUT0_FEATURE_PITCH (1*896*1*1*1*1)
#define INPUT0_BATCH_PITCH (1*896*1*1*1*1*(shape_info[1]  + 0))
...
#define INPUT1_FEATURE_PITCH 896
#define INPUT1_BATCH_PITCH 896
...
#define OUTPUT_BATCH_NUM (shape_info[8] )
...
#define OUTPUT_Z_PITCH (1*896)
#define OUTPUT_W_PITCH (1*896*1)
#define OUTPUT_U_PITCH (1*896*1*1)
#define OUTPUT_V_PITCH (1*896*1*1*1)
#define OUTPUT_FEATURE_PITCH (1*896*1*1*1*1)
#define OUTPUT_BATCH_PITCH (1*896*1*1*1*1*(shape_info[9]  + 0))
...
#define EPSILON as_float(0x358637bd)/*1.000000e-06*/
#define ACCUMULATOR_TYPE float
#define ACCUMULATOR_VAL_MAX FLT_MAX
#define ACCUMULATOR_VAL_MIN -ACCUMULATOR_VAL_MAX
#define ACCUMULATOR_VAL_ONE 1.0f
#define ACCUMULATOR_VAL_ZERO 0.0f
#define TO_ACCUMULATOR_TYPE(v) convert_float(v)
#define TO_ACCUMULATOR_TYPE_SAT(v) convert_float(v)
#define AS_ACCUMULATOR_TYPE(v) as_float(v)
...
//====================================================
// Kernel template: rope_ref 
// Kernel name: rope_ref_11982042700243959200_0_0__sa
#define KERNEL(name) __kernel void rope_ref_11982042700243959200_0_0__sa
#define KERNEL_ID rope_ref_11982042700243959200_0_0__sa
#define FUNC(name)  _##name##_rope_ref_11982042700243959200_0_0__sa
#define FUNC_CALL(name)  _##name##_rope_ref_11982042700243959200_0_0__sa
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_rope_ref_11982042700243959200_0_0__sa []
#define CONST_ARRAY_REF(name)  _##name##_rope_ref_11982042700243959200_0_0__sa
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define INPUT0_BATCH_NUM (shape_info[0] )
#define INPUT0_PAD_BEFORE_SIZE_X 0
#define INPUT0_PAD_BEFORE_SIZE_Y (shape_info[8])
#define INPUT0_PAD_BEFORE_SIZE_Z 0
#define INPUT0_PAD_BEFORE_SIZE_W 0
#define INPUT0_PAD_BEFORE_SIZE_U 0
#define INPUT0_PAD_BEFORE_SIZE_V 0
...
#define INPUT0_PAD_BEFORE_BATCH_NUM 0
#define INPUT0_PAD_AFTER_SIZE_X 0
#define INPUT0_PAD_AFTER_SIZE_Y (shape_info[9])
#define INPUT0_PAD_AFTER_SIZE_Z 0
#define INPUT0_PAD_AFTER_SIZE_W 0
#define INPUT0_PAD_AFTER_SIZE_U 0
#define INPUT0_PAD_AFTER_SIZE_V 0
...
#define INPUT0_Z_PITCH (64*(14  + (shape_info[8] + shape_info[9])))
#define INPUT0_W_PITCH (64*(14  + (shape_info[8] + shape_info[9]))*1)
#define INPUT0_U_PITCH (64*(14  + (shape_info[8] + shape_info[9]))*1*1)
#define INPUT0_V_PITCH (64*(14  + (shape_info[8] + shape_info[9]))*1*1*1)
#define INPUT0_FEATURE_PITCH (64*(14  + (shape_info[8] + shape_info[9]))*1*1*1*1)
#define INPUT0_BATCH_PITCH (64*(14  + (shape_info[8] + shape_info[9]))*1*1*1*1*(shape_info[1]  + 0))
#define INPUT0_GET_INDEX_SAFE(b, f, y, x) GET_DATA_INDEX_SAFE(INPUT0, b, f, y, x)
#define INPUT0_GET_INDEX(b, f, y, x) GET_DATA_INDEX(INPUT0, b, f, y, x)
#define INPUT0_GET_INDEX_RAW(b, f, y, x) GET_DATA_INDEX_RAW(INPUT0, b, f, y, x)
#define INPUT0_VIEW_OFFSET 0
...
#define INPUT1_SIZE_Y (shape_info[16] )
#define INPUT1_SIZE_Z 1
#define INPUT1_SIZE_W 1
#define INPUT1_SIZE_U 1
#define INPUT1_SIZE_V 1
#define INPUT1_FEATURE_NUM 1
#define INPUT1_BATCH_NUM (shape_info[10] )
#define INPUT1_PAD_BEFORE_SIZE_X 0
#define INPUT1_PAD_BEFORE_SIZE_Y 0
#define INPUT1_PAD_BEFORE_SIZE_Z 0
#define INPUT1_PAD_BEFORE_SIZE_W 0
...
#define INPUT1_Z_PITCH (64*(shape_info[16]  + 0))
#define INPUT1_W_PITCH (64*(shape_info[16]  + 0)*1)
#define INPUT1_U_PITCH (64*(shape_info[16]  + 0)*1*1)
#define INPUT1_V_PITCH (64*(shape_info[16]  + 0)*1*1*1)
#define INPUT1_FEATURE_PITCH (64*(shape_info[16]  + 0)*1*1*1*1)
#define INPUT1_BATCH_PITCH (64*(shape_info[16]  + 0)*1*1*1*1*1)
#define INPUT1_GET_INDEX_SAFE(b, f, y, x) GET_DATA_INDEX_SAFE(INPUT1, b, f, y, x)
#define INPUT1_GET_INDEX(b, f, y, x) GET_DATA_INDEX(INPUT1, b, f, y, x)
#define INPUT1_GET_INDEX_RAW(b, f, y, x) GET_DATA_INDEX_RAW(INPUT1, b, f, y, x)
#define INPUT1_VIEW_OFFSET 0
...
#define INPUT2_Z_PITCH (64*(shape_info[24]  + 0))
#define INPUT2_W_PITCH (64*(shape_info[24]  + 0)*1)
#define INPUT2_U_PITCH (64*(shape_info[24]  + 0)*1*1)
#define INPUT2_V_PITCH (64*(shape_info[24]  + 0)*1*1*1)
#define INPUT2_FEATURE_PITCH (64*(shape_info[24]  + 0)*1*1*1*1)
#define INPUT2_BATCH_PITCH (64*(shape_info[24]  + 0)*1*1*1*1*1)
...
#define OUTPUT_SIZE_Y (shape_info[32] )
#define OUTPUT_SIZE_Z 1
#define OUTPUT_SIZE_W 1
#define OUTPUT_SIZE_U 1
#define OUTPUT_SIZE_V 1
#define OUTPUT_FEATURE_NUM 14
#define OUTPUT_BATCH_NUM (shape_info[26] )
#define OUTPUT_PAD_BEFORE_SIZE_X 0
#define OUTPUT_PAD_BEFORE_SIZE_Y 0
#define OUTPUT_PAD_BEFORE_SIZE_Z 0
#define OUTPUT_PAD_BEFORE_SIZE_W 0
...
#define OUTPUT_Z_PITCH (64*(shape_info[32]  + 0))
#define OUTPUT_W_PITCH (64*(shape_info[32]  + 0)*1)
#define OUTPUT_U_PITCH (64*(shape_info[32]  + 0)*1*1)
#define OUTPUT_V_PITCH (64*(shape_info[32]  + 0)*1*1*1)
#define OUTPUT_FEATURE_PITCH (64*(shape_info[32]  + 0)*1*1*1*1)
#define OUTPUT_BATCH_PITCH (64*(shape_info[32]  + 0)*1*1*1*1*14)
#define OUTPUT_GET_INDEX_SAFE(b, f, y, x) GET_DATA_INDEX_SAFE(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX(b, f, y, x) GET_DATA_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX_RAW(b, f, y, x) GET_DATA_INDEX_RAW(OUTPUT, b, f, y, x)
#define OUTPUT_VIEW_OFFSET 0
...
#define OPTIONAL_SHAPE_INFO_TENSOR shape_info,
#define HEAD_SIZE 0
#define ROTARY_NDIMS 64
#define HALF_ROTARY_NDIMS 32
#define HEAD_COUNT 0
...
#undef ROTARY_NDIMS
#endif
#ifdef HALF_ROTARY_NDIMS
#undef HALF_ROTARY_NDIMS
#endif
#ifdef HEAD_COUNT
#undef HEAD_COUNT
#endif
#ifdef ENABLE_TRANSPOSE
#undef ENABLE_TRANSPOSE
#endif
#ifdef RotateHalf
#undef RotateHalf
#endif
...
// Kernel name: sdpa_opt_single_token_7001936805389565166_0_0__sa
#define KERNEL(name) __kernel void sdpa_opt_single_token_7001936805389565166_0_0__sa
#define KERNEL_ID sdpa_opt_single_token_7001936805389565166_0_0__sa
#define FUNC(name)  _##name##_sdpa_opt_single_token_7001936805389565166_0_0__sa
#define FUNC_CALL(name)  _##name##_sdpa_opt_single_token_7001936805389565166_0_0__sa
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_sdpa_opt_single_token_7001936805389565166_0_0__sa []
#define CONST_ARRAY_REF(name)  _##name##_sdpa_opt_single_token_7001936805389565166_0_0__sa
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define INPUT0_X_PITCH 1
#define INPUT0_Y_PITCH 64
#define INPUT0_Z_PITCH (64*(shape_info[6]  + 0))
#define INPUT0_W_PITCH (64*(shape_info[6]  + 0)*1)
#define INPUT0_U_PITCH (64*(shape_info[6]  + 0)*1*1)
#define INPUT0_V_PITCH (64*(shape_info[6]  + 0)*1*1*1)
#define INPUT0_FEATURE_PITCH (64*(shape_info[6]  + 0)*1*1*1*1)
#define INPUT0_BATCH_PITCH (64*(shape_info[6]  + 0)*1*1*1*1*14)
#define INPUT0_GET_INDEX_SAFE(b, f, y, x) GET_DATA_INDEX_SAFE(INPUT0, b, f, y, x)
#define INPUT0_GET_INDEX(b, f, y, x) GET_DATA_INDEX(INPUT0, b, f, y, x)
#define INPUT0_GET_INDEX_RAW(b, f, y, x) GET_DATA_INDEX_RAW(INPUT0, b, f, y, x)
#define INPUT0_VIEW_OFFSET 0
...
#define INPUT1_X_PITCH 1
#define INPUT1_Y_PITCH 64
#define INPUT1_Z_PITCH (64*(shape_info[14]  + (shape_info[16] + shape_info[17])))
#define INPUT1_W_PITCH (64*(shape_info[14]  + (shape_info[16] + shape_info[17]))*1)
#define INPUT1_U_PITCH (64*(shape_info[14]  + (shape_info[16] + shape_info[17]))*1*1)
#define INPUT1_V_PITCH (64*(shape_info[14]  + (shape_info[16] + shape_info[17]))*1*1*1)
#define INPUT1_FEATURE_PITCH (64*(shape_info[14]  + (shape_info[16] + shape_info[17]))*1*1*1*1)
#define INPUT1_BATCH_PITCH (64*(shape_info[14]  + (shape_info[16] + shape_info[17]))*1*1*1*1*2)
#define INPUT1_GET_INDEX_SAFE(b, f, y, x) GET_DATA_INDEX_SAFE(INPUT1, b, f, y, x)
#define INPUT1_GET_INDEX(b, f, y, x) GET_DATA_INDEX(INPUT1, b, f, y, x)
#define INPUT1_GET_INDEX_RAW(b, f, y, x) GET_DATA_INDEX_RAW(INPUT1, b, f, y, x)
#define INPUT1_VIEW_OFFSET 0
...
#define INPUT2_X_PITCH 1
#define INPUT2_Y_PITCH 64
#define INPUT2_Z_PITCH (64*(shape_info[24]  + (shape_info[26] + shape_info[27])))
#define INPUT2_W_PITCH (64*(shape_info[24]  + (shape_info[26] + shape_info[27]))*1)
#define INPUT2_U_PITCH (64*(shape_info[24]  + (shape_info[26] + shape_info[27]))*1*1)
#define INPUT2_V_PITCH (64*(shape_info[24]  + (shape_info[26] + shape_info[27]))*1*1*1)
#define INPUT2_FEATURE_PITCH (64*(shape_info[24]  + (shape_info[26] + shape_info[27]))*1*1*1*1)
#define INPUT2_BATCH_PITCH (64*(shape_info[24]  + (shape_info[26] + shape_info[27]))*1*1*1*1*2)
#define INPUT2_GET_INDEX_SAFE(b, f, y, x) GET_DATA_INDEX_SAFE(INPUT2, b, f, y, x)
#define INPUT2_GET_INDEX(b, f, y, x) GET_DATA_INDEX(INPUT2, b, f, y, x)
#define INPUT2_GET_INDEX_RAW(b, f, y, x) GET_DATA_INDEX_RAW(INPUT2, b, f, y, x)
#define INPUT2_VIEW_OFFSET 0
...
#define OUTPUT_X_PITCH 1
#define OUTPUT_Y_PITCH 64
#define OUTPUT_Z_PITCH (64*(shape_info[50]  + 0))
#define OUTPUT_W_PITCH (64*(shape_info[50]  + 0)*1)
#define OUTPUT_U_PITCH (64*(shape_info[50]  + 0)*1*1)
#define OUTPUT_V_PITCH (64*(shape_info[50]  + 0)*1*1*1)
#define OUTPUT_FEATURE_PITCH (64*(shape_info[50]  + 0)*1*1*1*1)
#define OUTPUT_BATCH_PITCH (64*(shape_info[50]  + 0)*1*1*1*1*14)
#define OUTPUT_GET_INDEX_SAFE(b, f, y, x) GET_DATA_INDEX_SAFE(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX(b, f, y, x) GET_DATA_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX_RAW(b, f, y, x) GET_DATA_INDEX_RAW(OUTPUT, b, f, y, x)
#define OUTPUT_VIEW_OFFSET 0
...
#define STATIC_SCALE_VALUE as_float(0x3dffffff)/*1.250000e-01*/
...
// Kernel name: sdpa_opt_multi_tokens_7001936805389565166_0_0__sa
#define KERNEL(name) __kernel void sdpa_opt_multi_tokens_7001936805389565166_0_0__sa
#define KERNEL_ID sdpa_opt_multi_tokens_7001936805389565166_0_0__sa
#define FUNC(name)  _##name##_sdpa_opt_multi_tokens_7001936805389565166_0_0__sa
#define FUNC_CALL(name)  _##name##_sdpa_opt_multi_tokens_7001936805389565166_0_0__sa
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_sdpa_opt_multi_tokens_7001936805389565166_0_0__sa []
#define CONST_ARRAY_REF(name)  _##name##_sdpa_opt_multi_tokens_7001936805389565166_0_0__sa
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
