...
int main(int argc, char **argv)
{
	...
	std::string root_path = "../../sycl_pipeline_rope_kernel/src/kernel_rope_ref/";
	...
	// dst0.txt: No enable build option.
	...
	// dst0_master.txt: enable build option.
	...
	// Dump result:
	std::string dump_fn = argc == 2 ? argv[1] : "out_opencl_rope_kernel.log";
